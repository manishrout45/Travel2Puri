    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          <div className="flex flex-wrap gap-2 mb-4">
            <span className="bg-blue-100 text-blue-700 text-xs px-3 py-1 rounded-full">#Пешие_прогулки</span>
            <span className="bg-blue-100 text-blue-700 text-xs px-3 py-1 rounded-full">#Зимний_прогулки</span>
          </div>
          <h2 className="text-2xl font-bold mb-3">Puri</h2>
          <h3 className="text-2xl font-medium mb-2">Where Spirituality Meets the Sea</h3>
          <p className="text-sm leading-relaxed mb-4">
            Embark on a memorable journey to Puri, one of the most sacred and scenic destinations in Odisha.
            Known for its vibrant culture, ancient temples, golden beaches, and divine atmosphere, Puri offers
            the perfect mix of spirituality, heritage, and leisure. Whether you're a pilgrim, a history enthusiast,
            or a nature lover — Puri has something special for everyone.
          </p>
          <p className="text-sm leading-relaxed mb-4">
      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Temps forts</h2>
            <p className="text-sm text-gray-600 max-w-xl">
              Retrouvez ici les dernières actualités de la Communauté de communes et les événements à venir
        ...
        {/* Cards */}
        <div className="flex gap-6 overflow-x-auto pb-4" id="scrollContainer">
          {/* Card 1 */}
          <div className="min-w-[250px] bg-white rounded-lg shadow hover:shadow-lg transition flex-shrink-0">
            ...
            <div className="p-4">
              ...
              <h3 className="font-semibold text-sm">Lancement du programme "Forêt vivante"</h3>
            </div>
          </div>
          ...
          <div className="min-w-[250px] bg-white rounded-lg shadow hover:shadow-lg transition flex-shrink-0">
            ...
            <div className="p-4">
              ...
              <h3 className="font-semibold text-sm">29.06 Journée nature & patrimoine</h3>
            </div>
          </div>
          ...
          <div className="min-w-[250px] bg-white rounded-lg shadow hover:shadow-lg transition flex-shrink-0">
            ...
            <div className="p-4">
              <p className="text-xs text-gray-500 mb-1">Publié le 12.05</p>
              <h3 className="font-semibold text-sm">Ouverture de France Service</h3>
            </div>
          </div>
        </div>
      </section>
