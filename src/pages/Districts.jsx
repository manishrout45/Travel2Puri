...
const Districts = () => {
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
      <h1 className="text-4xl font-bold text-blue-600 mb-8 text-center">Odisha Districts & Destinations</h1>
            ...
            {district.destinations.map((dest) => (
             <Link to={`/destination/${dest.id}`}
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="text-lg font-bold text-blue-500">{dest.name}</h3>
